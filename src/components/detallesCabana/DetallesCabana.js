...
const DetallesCabana = () => {
  ...
  //const [ocultarContenedor, setOcultarContenedor] = useState("");
  const [mostrarComponenteReservar, setMostrarComponenteReservar] =
    useState(false);
  const [mostrarModalUsuarioNoRegistrado, setMostrarModalUsuarioNoRegistrado] =
    useState("");
  ...
  return (
    <>
      ...
      <div className={`contenedor-detalles-cabana`}>
        {" "}
        {/*En esta clase iba esto ${ocultarContenedor} */}
        <Container className="carousel-container">
          <Carousel fade>
            {images.map((image, index) => (
              <Carousel.Item key={index}>
        ...
        {localStorage.getItem("role") === "admin" && (
          <div className="contenedor-botones-admin">
            <div className="botones-admin">
              ...
              <Link to={`/verFechas/${cabaña._id}`}>
                <button className="boton-fechas-disponibles">
                  Fechas Disponibles
                </button>
              </Link>
        ...
        )} */}
        {
          <div className="container-modal-usuario-no-registrado">
            <div
              className={`usuario-no-registrado ${mostrarModalUsuarioNoRegistrado}`}
            >
              <p
                onClick={onClickOcultarModalUNR}
                className={`close-usuario-no-registrado`}
              >
                X
              </p>
        ...
        {mostrarComponenteReservar ? (
          <div className="content-reservar">
            <div className="reservar">
              <p
                onClick={onClickOcultarReservar}
                className="close-confirmar-fechas"
              >
                X
              </p>
              <ModalReservar />
